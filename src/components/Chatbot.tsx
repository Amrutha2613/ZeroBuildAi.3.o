  ...
  const handleSendText = async () => {
    ...
    try {
      if (!process.env.GEMINI_API_KEY) {
        setMessages(prev => [...prev, { role: 'ai', text: "AI features are currently in Demo Mode. To enable full AI capabilities, please add your GEMINI_API_KEY to the environment variables in Vercel." }]);
        return;
      }
